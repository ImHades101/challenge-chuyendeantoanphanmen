...
<section class="jumbotron" style="height: 290px; margin-bottom: 62px;padding-top: 95px;">
<div class="container">
    <div class="row">
      <div class="col-md-12 inner-contant">
         <h1 data-aos="zoom-in" data-aos-duration="1000">Read Our Blog</h1>
      </div>
    </div>
</div>
</section>
...
<div class="container">
   <!-- Row Start-->
    <div class="row" style="padding-bottom: 25px;">
        <div class="col-xs-12 col-sm-4 col-md-4 " data-aos="fade-right" data-aos-duration="2000">
            <img src="images/blog/post-1.jpg" alt="test" class="img-responsive">
        ...
        <div class="col-xs-12 col-sm-4 col-md-4 " data-aos="fade-right" data-aos-duration="2000">
            <img src="images/blog/post-2.jpg" alt="test" class="img-responsive">
            <div class="carousel-caption">
               <a href="blog-page.html" class="btn btn-info" role="button">Everest</a>
               <a href="blog-page.html"><h5>Wonderful Mount everest of india, beautiful scene.</h5></a>
            </div>
         </div>
        <div class="col-xs-12 col-sm-4 col-md-4 " data-aos="fade-right" data-aos-duration="2000">
            <img src="images/blog/post-3.jpg" alt="test" class="img-responsive">
            <div class="carousel-caption">
    ...
    <div class="row" style="padding-bottom: 30px;">
        <div class="col-xs-12 col-sm-4 col-md-4 " data-aos="fade-left" data-aos-duration="2000">
            <img src="images/blog/post-1.jpg" alt="test" class="img-responsive">
            <div class="carousel-caption">
               <a href="blog-page.html" class="btn btn-info" role="button">California</a>
               <a href="blog-page.html"><h5>Beautiful road like waterfall in the california of south most beautiful view.</h5></a>
