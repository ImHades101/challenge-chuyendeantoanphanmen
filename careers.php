...
<div class="container">
    <div class="row">
      <div class="col-md-12 inner-contant">
         <h1 data-aos="zoom-in" data-aos-duration="1000">Recent Openings</h1>
      </div>
    </div>
</div>
</section>
   ...
   <!-- Container Start -->
     <div class="container">
        ...
        <!-- First Row Start -->
         <div class="row">
             <div class="col-xs-12 col-sm-3">
                 <img class="img-responsive career-img" src="images/portfolio/career-1.jpg" alt="" data-aos="flip-left"  data-aos-duration="1000">
             </div>
             <div class="col-xs-12 col-sm-9">
               <div class="contant" data-aos="fade-up" data-aos-duration="1000">
                 <h3>Needed a Wedding Photographer</h3>
        ...
        <!-- Second Row Start -->
         <div class="row">
             <div class="col-sm-3">
                 <img class="img-responsive career-img" src="images/portfolio/career-2.jpg" alt="" data-aos="flip-right"  data-aos-duration="1000">
             </div>
             <div class="col-sm-9">
               <div class="contant" data-aos="fade-up" data-aos-duration="1000">
                 <h3>Portrait Specialists Requireds</h3>
                 <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
                 </p>
               </div>
             </div>
        ...
        <!-- Third Row Start -->
         <div class="row">
             <div class="col-sm-3">
                 <img class="img-responsive career-img" src="images/portfolio/career-3.jpg" alt="" data-aos="flip-left"  data-aos-duration="1000">
             </div>
             <div class="col-sm-9">
               <div class="contant" data-aos="fade-up" data-aos-duration="1000">
                 <h3>Needed a Wedding Photographer</h3>
