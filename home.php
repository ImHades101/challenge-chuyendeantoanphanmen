...
<header>
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-4 col-md-4">
                <a class="logo" href="index.html"><img src="images/logo/logo.jpg" alt=""></a>
            </div>
            <div class="col-xs-12 col-sm-4 col-md-4">
      ...
      <div class="header-section">
        <div class="collapse navbar-collapse" id="myNavbar">
         <ul class="nav navbar-nav navbar-center">
             <li><a  href="/cado/?file=home.php">Home Page</a></li>
             <li class="hidden-xs">-</li>
             <li><a class="active"  href="/cado/?file=blog.php">Blog</a></li>
             <li class="hidden-xs">-</li>
...
<div class="container">
    <div class="row">
      <div class="col-md-12 inner-contant" style="padding-bottom: 0;">
         <h1 data-aos="zoom-in" data-aos-duration="1000">Portfolio</h1>
      </div>
    </div>
</div>
</section>
  ...
  <div class="row">
    <div class="main_portfolio_content">
        <div class="gallery_product col-md-3 col-sm-4 col-xs-6 filter portarits">
            <img src="images/portfolio/b1.jpg" class="img-responsive" alt="image-1" />
        ...
        <div class="gallery_product col-md-3 col-sm-4 col-xs-6 filter landscapes">
            <img src="images/portfolio/b.jpg" class="img-responsive" alt="image-2" />
            <div class="portfolio_images_overlay text-center">
                <h6>people on tracks <br>
                <span>Food & Diet  - <a href="#"><i class="fa fa-comment" aria-hidden="true" style="color: white;"></i></a> (23)</span>
                </h6>
        ...
        <div class="gallery_product col-md-3 col-sm-4 col-xs-6 filter fashion weddings">
            <img src="images/portfolio/b2.jpg" class="img-responsive" alt="image-3" />
            <div class="portfolio_images_overlay text-center">
                <h6>people on tracks <br>
                    <span>Food & Diet  - <a href="#"><i class="fa fa-comment" aria-hidden="true" style="color: white;"></i> </a> (23)</span>
                </h6>
        ...
        <div class="gallery_product col-md-3 col-sm-4 col-xs-6 filter portarits fashion">
            <img src="images/portfolio/b.jpg" class="img-responsive" alt="image-4" />
            <div class="portfolio_images_overlay text-center">
                <h6>people on tracks <br>
                <span>Food & Diet  -<a href="#"><i class="fa fa-comment" aria-hidden="true" style="color: white;"></i> </a> (23)</span>
                </h6>
        ...
        <div class="gallery_product col-md-3 col-sm-4 col-xs-6 filter landscapes portarits">
            <img src="images/portfolio/b.jpg" class="img-responsive" alt="image-5" />
            <div class="portfolio_images_overlay text-center">
                <h6>people on tracks <br>
                <span>Food & Diet  - <a href="#"><i class="fa fa-comment" aria-hidden="true" style="color: white;"></i> </a> (23)</span>
                </h6>
        ...
        <div class="gallery_product col-md-3 col-sm-4 col-xs-6 filter weddings landscapes">
            <img src="images/portfolio/b4.jpg" class="img-responsive" alt="image-6" />
            <div class="portfolio_images_overlay text-center">
                <h6>people on tracks <br>
                <span>Food & Diet  - <a href="#"><i class="fa fa-comment" aria-hidden="true" style="color: white;"></i> </a> (23)</span>
                </h6>
        ...
        <div class="gallery_product col-md-3 col-sm-4 col-xs-6 filter weddings">
            <img src="images/portfolio/b6.jpg" class="img-responsive" alt="image-7" />
            <div class="portfolio_images_overlay text-center">
                <h6>people on tracks <br>
                <span>Food & Diet  - <a href="#"><i class="fa fa-comment" aria-hidden="true" style="color: white;"></i> </a> (23)</span>
                </h6>
        ...
        <div class="gallery_product col-md-3 col-sm-4 col-xs-6 filter fashion">
            <img src="images/portfolio/b7.jpg" class="img-responsive" alt="image-8" />
            <div class="portfolio_images_overlay text-center">
                <h6>people on tracks <br>
                <span>Food & Diet  - <a href="#"><i class="fa fa-comment" aria-hidden="true" style="color: white;"></i> </a> (23)</span>
                </h6>
        ...
        <div class="gallery_product col-md-3 col-sm-4 col-xs-6 filter portarits">
            <img src="images/portfolio/b8.jpg" class="img-responsive" alt="image-9" />
            <div class="portfolio_images_overlay text-center">
                <h6>people on tracks <br>
                <span>Food & Diet  - <a href="#"><i class="fa fa-comment" aria-hidden="true" style="color: white;"></i> </a> (23)</span>
                </h6>
        ...
        <div class="gallery_product col-md-3 col-sm-4 col-xs-6 filter landscapes">
            <img src="images/portfolio/p1.jpg" class="img-responsive" alt="image-10" />
            <div class="portfolio_images_overlay text-center">
                <h6>people on tracks <br>
                <span>Food & Diet  - <a href="#"><i class="fa fa-comment" aria-hidden="true" style="color: white;"></i> </a> (23)</span>
                </h6>
        ...
        <div class="gallery_product col-md-3 col-sm-4 col-xs-6 filter weddings">
            <img src="images/portfolio/p2.jpg" class="img-responsive" alt="image-11" />
            <div class="portfolio_images_overlay text-center">
                <h6>people on tracks <br>
                <span>Food & Diet  - <a href="#"><i class="fa fa-comment" aria-hidden="true" style="color: white;"></i> </a> (23)</span>
                </h6>
        ...
        <div class="gallery_product col-md-3 col-sm-4 col-xs-6 filter fashion">
            <img src="images/portfolio/p3.jpg" class="img-responsive" alt="image-12" />
            <div class="portfolio_images_overlay text-center">
                <h6>people on tracks <br>
                <span>Food & Diet  - <a href="#"><i class="fa fa-comment" aria-hidden="true" style="color: white;"></i> </a> (23)</span>
                </h6>
